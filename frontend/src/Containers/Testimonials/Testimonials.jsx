...
const Testimonials = () => {
  ...
  const testimonail = testimonials[currentIndex]
        ...
        {testimonials.length && (
          <>
              <div className = 'app__testimonial-item app__flex'>
                  <img src = {urlFor(testimonail.imageUrl)} alt = {testimonials}/>
                  <div className = 'app__testimonial-content'>
                      <p className = 'p-text'>{testimonail.feedback}</p>
                      <div>
                          <h4 className = 'bold-text'>{testimonail.name}</h4>
                          <h5 className = 'p-text'>{testimonail.company}</h5>
                      </div>
                  </div>
              </div>
